...
public class FirmwareMqttClient extends AsyncTask<String, Void, Boolean> {
    private Context context;
    private JsonObject body;
    private String macAddress;
    public FirmwareMqttClient(Context context, JsonObject body, String macAddress) {
...
//            options.setKeepAliveInterval(30);
            ...
            if(client.isConnected()){
                try {
                    ...
                    client.publish(Configuration.MqttTopic+ "firmware/"+ macAddress , message);
                    client.disconnect();
                } catch (Exception e) {
