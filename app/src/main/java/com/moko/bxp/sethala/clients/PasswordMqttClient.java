...
public class PasswordMqttClient extends AsyncTask<String, Void, Boolean> {
    private Context context;
    private JsonObject body;
    private String macAddress;
    public PasswordMqttClient(Context context, JsonObject body, String macAddress) {
...
//            options.setKeepAliveInterval(30);
            ...
            if(client.isConnected()){
                try {
                    ...
                    client.publish(Configuration.MqttTopic+ "password/"+ macAddress , message);
                } catch (Exception e) {
